...
speeduinoDataList speeduinodDevice[NUMBER_OF_SPEEDUINO_AVAILABLE_DEVICES + 1] = {
    // Send to DWIN, Minimum update freq, Speeduino LowByte, Speeduino NumberOfBytes, Name, DWIN VP
    {false, 5000, 0, 1, id000, 0x10, 0x00},
    {false, 5000, 1, 1, id001, 0x10, 0x20},
    {false, 5000, 2, 1, id002, 0x10, 0x40},
    {false, 5000, 3, 1, id003, 0x10, 0x60},
    {true, 100, 4, 2, id004, 0x10, 0x80},
    {false, 5000, 6, 1, id005, 0x11, 0x00},
    {false, 5000, 7, 1, id006, 0x11, 0x20},
    {false, 5000, 8, 1, id007, 0x11, 0x40},
    {true, 1000, 9, 1, id008, 0x11, 0x60},
    {false, 5000, 10, 1, id009, 0x11, 0x80},
    {false, 5000, 11, 1, id010, 0x12, 0x00},
    {false, 5000, 12, 1, id011, 0x12, 0x20},
    {false, 5000, 13, 1, id012, 0x12, 0x40},
    {true, 100, 14, 2, id013, 0x12, 0x60},
    {false, 5000, 16, 1, id014, 0x12, 0x80},
    {false, 5000, 17, 1, id015, 0x13, 0x00},
    {false, 5000, 18, 1, id016, 0x13, 0x20},
    {false, 5000, 19, 1, id017, 0x13, 0x40},
    {true, 100, 20, 2, id018, 0x13, 0x60},
    {false, 5000, 22, 1, id019, 0x13, 0x80},
    {false, 5000, 23, 1, id020, 0x14, 0x00},
    {false, 5000, 24, 1, id021, 0x14, 0x20},
    {false, 5000, 25, 2, id022, 0x14, 0x40},
    {false, 5000, 27, 2, id023, 0x14, 0x60},
    {false, 5000, 29, 1, id024, 0x14, 0x80},
    {false, 5000, 30, 1, id025, 0x15, 0x00},
    {false, 5000, 31, 1, id026, 0x15, 0x20},
    {false, 5000, 32, 2, id027, 0x15, 0x40},
    {false, 5000, 34, 1, id028, 0x15, 0x60},
    {false, 5000, 35, 1, id029, 0x15, 0x80},
    {false, 5000, 36, 1, id030, 0x16, 0x00},
    {false, 5000, 37, 1, id031, 0x16, 0x20},
    {false, 5000, 38, 1, id032, 0x16, 0x40},
    {false, 5000, 39, 1, id033, 0x16, 0x60},
    {false, 5000, 40, 1, id034, 0x16, 0x80},
    {false, 5000, 41, 2, id035, 0x17, 0x00},
    {false, 5000, 43, 2, id036, 0x17, 0x20},
    {false, 5000, 45, 2, id037, 0x17, 0x40},
    {false, 5000, 47, 2, id038, 0x17, 0x60},
    {false, 5000, 49, 2, id039, 0x17, 0x80},
    {false, 5000, 51, 2, id040, 0x18, 0x00},
    {false, 5000, 53, 2, id041, 0x18, 0x20},
    {false, 5000, 55, 2, id042, 0x18, 0x40},
    {false, 5000, 57, 2, id043, 0x18, 0x60},
    {false, 5000, 59, 2, id044, 0x18, 0x80},
    {false, 5000, 61, 2, id045, 0x19, 0x00},
    {false, 5000, 63, 2, id046, 0x19, 0x20},
    {false, 5000, 65, 2, id047, 0x19, 0x40},
    {false, 5000, 67, 2, id048, 0x19, 0x60},
    {false, 5000, 69, 2, id049, 0x19, 0x80},
    {false, 5000, 71, 2, id050, 0x20, 0x00},
    {false, 5000, 73, 1, id051, 0x20, 0x20},
    {false, 5000, 74, 1, id052, 0x20, 0x40},
    {false, 5000, 75, 1, id053, 0x20, 0x60},
    {false, 5000, 76, 2, id054, 0x20, 0x80},
    {false, 5000, 78, 2, id055, 0x21, 0x00},
    {false, 5000, 80, 2, id056, 0x21, 0x20},
    {false, 5000, 82, 1, id057, 0x21, 0x40},
    {false, 5000, 83, 1, id058, 0x21, 0x60},
    {false, 5000, 84, 2, id059, 0x21, 0x80},
    {false, 5000, 86, 2, id060, 0x22, 0x00},
    {false, 5000, 88, 2, id061, 0x22, 0x20},
    {false, 5000, 90, 1, id062, 0x22, 0x40},
    {false, 5000, 91, 1, id063, 0x22, 0x60},
    {false, 5000, 92, 1, id064, 0x22, 0x80},
    {false, 5000, 93, 1, id065, 0x23, 0x00},
    {false, 5000, 94, 1, id066, 0x23, 0x20},
    {false, 5000, 95, 1, id067, 0x23, 0x40},
    {false, 5000, 96, 2, id068, 0x23, 0x60},
    {false, 5000, 98, 1, id069, 0x23, 0x80},
    {false, 5000, 99, 1, id070, 0x24, 0x00},
    {false, 5000, 100, 2, id071, 0x24, 0x20},
    {false, 5000, 102, 1, id072, 0x24, 0x40},
    {false, 5000, 103, 1, id073, 0x24, 0x60},
    {false, 5000, 104, 1, id074, 0x24, 0x80},
    {false, 5000, 105, 1, id075, 0x25, 0x00},
    {false, 5000, 106, 1, id076, 0x25, 0x20},
    {false, 5000, 107, 1, id077, 0x25, 0x40},
    {false, 5000, 108, 1, id078, 0x25, 0x60},
    {false, 5000, 109, 1, id079, 0x25, 0x80},
    {false, 5000, 110, 1, id080, 0x26, 0x00},
    {false, 5000, 111, 1, id081, 0x26, 0x20},
    {false, 5000, 112, 1, id082, 0x26, 0x40},
    {false, 5000, 113, 1, id083, 0x26, 0x60},
    {false, 5000, 114, 1, id084, 0x26, 0x80},
    {false, 5000, 115, 1, id085, 0x27, 0x00},
    {false, 5000, 116, 1, id086, 0x27, 0x20},
    {false, 5000, 117, 1, id087, 0x27, 0x40},
    {false, 5000, 118, 1, id088, 0x27, 0x60}
