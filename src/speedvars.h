...
speeduinoDataList speeduinodDevice[NUMBER_OF_SPEEDUINO_AVAILABLE_DEVICES + 1] = {
    ...
    {true, 5000, 2, 1, id002, 0x0128, 0x012C, 0x0130},
    {true, 5000, 3, 1, id003, 0x013C, 0x0140, 0x0144},
    {true, 100, 4, 2, id004, 0x0150, 0x0154, 0x0158},
    {true, 5000, 6, 1, id005, 0x0164, 0x0168, 0x016C},
    {true, 5000, 7, 1, id006, 0x0178, 0x017C, 0x0180},
    {false, 5000, 8, 1, id007, 0x018C, 0x0190, 0x0194},
    {true, 5000, 9, 1, id008, 0x01A0, 0x01A4, 0x01A8},
    {true, 5000, 10, 1, id009, 0x01B4, 0x01B8, 0x01BC},
    {true, 5000, 11, 1, id010, 0x01C8, 0x01CC, 0x01D0},
    {true, 5000, 12, 1, id011, 0x01DC, 0x01E0, 0x01E4},
    {true, 5000, 13, 1, id012, 0x01F0, 0x01F4, 0x01F8},
    {true, 100, 14, 2, id013, 0x0204, 0x0208, 0x020C},
    {true, 5000, 16, 1, id014, 0x0218, 0x021C, 0x0220},
    {true, 5000, 17, 1, id015, 0x022C, 0x0230, 0x0234},
    {true, 5000, 18, 1, id016, 0x0240, 0x0244, 0x0248},
    {true, 5000, 19, 1, id017, 0x0254, 0x0258, 0x025C},
    {true, 100, 20, 2, id018, 0x0268, 0x026C, 0x0270},
    {true, 5000, 22, 1, id019, 0x027C, 0x0280, 0x0284},
    {true, 5000, 23, 1, id020, 0x0290, 0x0294, 0x0298},
    {true, 5000, 24, 1, id021, 0x02A4, 0x02A8, 0x02AC},
    {true, 5000, 25, 2, id022, 0x02B8, 0x02BC, 0x02C0},
    {true, 5000, 27, 2, id023, 0x02CC, 0x02D0, 0x02D4},
    {true, 5000, 29, 1, id024, 0x02E0, 0x02E4, 0x02E8},
    {true, 5000, 30, 1, id025, 0x02F4, 0x02F8, 0x02FC},
    {true, 5000, 31, 1, id026, 0x0308, 0x030C, 0x0310},
    {true, 5000, 32, 2, id027, 0x031C, 0x0320, 0x0324},
    {true, 5000, 34, 1, id028, 0x0330, 0x0334, 0x0338},
    {true, 5000, 35, 1, id029, 0x0344, 0x0348, 0x034C},
    {true, 5000, 36, 1, id030, 0x0358, 0x035C, 0x0360},
    {true, 5000, 37, 1, id031, 0x036C, 0x0370, 0x0374},
    {true, 5000, 38, 1, id032, 0x0380, 0x0384, 0x0388},
    {true, 5000, 39, 1, id033, 0x0394, 0x0398, 0x039C},
    {true, 5000, 40, 1, id034, 0x03A8, 0x03AC, 0x03B0},
    {true, 5000, 41, 2, id035, 0x03BC, 0x03C0, 0x03C4},
    {true, 5000, 43, 2, id036, 0x03D0, 0x03D4, 0x03D8},
    {true, 5000, 45, 2, id037, 0x03E4, 0x03E8, 0x03EC},
    {true, 5000, 47, 2, id038, 0x03F8, 0x03FC, 0x0400},
    {true, 5000, 49, 2, id039, 0x040C, 0x0410, 0x0414},
    {true, 5000, 51, 2, id040, 0x0420, 0x0424, 0x0428},
    {true, 5000, 53, 2, id041, 0x0434, 0x0438, 0x043C},
    {true, 5000, 55, 2, id042, 0x0448, 0x044C, 0x0450},
    {true, 5000, 57, 2, id043, 0x045C, 0x0460, 0x0464},
    {true, 5000, 59, 2, id044, 0x0470, 0x0474, 0x0478},
    {true, 5000, 61, 2, id045, 0x0484, 0x0488, 0x048C},
    {true, 5000, 63, 2, id046, 0x0498, 0x049C, 0x04A0},
    {true, 5000, 65, 2, id047, 0x04AC, 0x04B0, 0x04B4},
    {true, 5000, 67, 2, id048, 0x04C0, 0x04C4, 0x04C8},
    {true, 5000, 69, 2, id049, 0x04D4, 0x04D8, 0x04DC},
    {true, 5000, 71, 2, id050, 0x04E8, 0x04EC, 0x04F0},
    {true, 5000, 73, 1, id051, 0x04FC, 0x0500, 0x0504},
    {true, 5000, 74, 1, id052, 0x0510, 0x0514, 0x0518},
    {true, 5000, 75, 1, id053, 0x0524, 0x0528, 0x052C},
    {true, 5000, 76, 2, id054, 0x0538, 0x053C, 0x0540},
    {true, 5000, 78, 2, id055, 0x054C, 0x0550, 0x0554},
    {true, 5000, 80, 2, id056, 0x0560, 0x0564, 0x0568},
    {true, 5000, 82, 1, id057, 0x0574, 0x0578, 0x057C},
    {true, 5000, 83, 1, id058, 0x0588, 0x058C, 0x0590},
    {true, 5000, 84, 2, id059, 0x059C, 0x05A0, 0x05A4},
    {true, 5000, 86, 2, id060, 0x05B0, 0x05B4, 0x05B8},
    {true, 5000, 88, 2, id061, 0x05C4, 0x05C8, 0x05CC},
    {true, 5000, 90, 1, id062, 0x05D8, 0x05DC, 0x05E0},
    {true, 5000, 91, 1, id063, 0x05EC, 0x05F0, 0x05F4},
    {true, 5000, 92, 1, id064, 0x0600, 0x0604, 0x0608},
    {true, 5000, 93, 1, id065, 0x0614, 0x0618, 0x061C},
    {true, 5000, 94, 1, id066, 0x0628, 0x062C, 0x0630},
    {true, 5000, 95, 1, id067, 0x063C, 0x0640, 0x0644},
    {true, 5000, 96, 2, id068, 0x0650, 0x0654, 0x0658},
    {true, 5000, 98, 1, id069, 0x0664, 0x0668, 0x066C},
    {true, 5000, 99, 1, id070, 0x0678, 0x067C, 0x0680},
    {true, 5000, 100, 2, id071, 0x068C, 0x0690, 0x0694},
    {true, 5000, 102, 1, id072, 0x06A0, 0x06A4, 0x06A8},
    {true, 5000, 103, 1, id073, 0x06B4, 0x06B8, 0x06BC},
    {true, 5000, 104, 1, id074, 0x06C8, 0x06CC, 0x06D0},
    {true, 5000, 105, 1, id075, 0x06DC, 0x06E0, 0x06E4},
    {true, 5000, 106, 1, id076, 0x06F0, 0x06F4, 0x06F8},
    {true, 5000, 107, 1, id077, 0x0704, 0x0708, 0x070C},
    {true, 5000, 108, 1, id078, 0x0718, 0x071C, 0x0720},
    {true, 5000, 109, 1, id079, 0x072C, 0x0730, 0x0734},
    {true, 5000, 110, 1, id080, 0x0740, 0x0744, 0x0748},
    {true, 5000, 111, 1, id081, 0x0754, 0x0758, 0x075C},
    {true, 5000, 112, 1, id082, 0x0768, 0x076C, 0x0770},
    {true, 5000, 113, 1, id083, 0x077C, 0x0780, 0x0784},
    {true, 5000, 114, 1, id084, 0x0790, 0x0794, 0x0798},
    {true, 5000, 115, 1, id085, 0x07A4, 0x07A8, 0x07AC},
    {true, 5000, 116, 1, id086, 0x07B8, 0x07BC, 0x07C0},
    {true, 5000, 117, 1, id087, 0x07CC, 0x07D0, 0x07D4},
    {true, 5000, 118, 1, id088, 0x07E0, 0x07E4, 0x07E8}
