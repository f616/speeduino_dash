...
speeduinoDataList speeduinodDevice[NUMBER_OF_SPEEDUINO_AVAILABLE_DEVICES + 1] = {
    // Send to DWIN true/true, Minimum update freq, Speeduino LowByte, Speeduino NumberOfBytes, Name, DWIN VP
    {true, 5000, 0, 1, id000, 0x0100},
    {true, 10, 1, 1, id001, 0x0114},
    {true, 5000, 2, 1, id002, 0x0128},
    {true, 5000, 3, 1, id003, 0x013C},
    {true, 100, 4, 2, id004, 0x0150},
    {true, 5000, 6, 1, id005, 0x0164},
    {true, 5000, 7, 1, id006, 0x0178},
    {true, 5000, 8, 1, id007, 0x018C},
    {true, 5000, 9, 1, id008, 0x01A0},
    {true, 5000, 10, 1, id009, 0x01B4},
    {true, 5000, 11, 1, id010, 0x01C8},
    {true, 5000, 12, 1, id011, 0x01DC},
    {true, 5000, 13, 1, id012, 0x01F0},
    {true, 100, 14, 2, id013, 0x0204},
    {true, 5000, 16, 1, id014, 0x0218},
    {true, 5000, 17, 1, id015, 0x022C},
    {true, 5000, 18, 1, id016, 0x0240},
    {true, 5000, 19, 1, id017, 0x0254},
    {true, 100, 20, 2, id018, 0x0268},
    {true, 5000, 22, 1, id019, 0x027C},
    {true, 5000, 23, 1, id020, 0x0290},
    {true, 5000, 24, 1, id021, 0x02A4},
    {true, 5000, 25, 2, id022, 0x02B8},
    {true, 5000, 27, 2, id023, 0x02CC},
    {true, 5000, 29, 1, id024, 0x02E0},
    {true, 5000, 30, 1, id025, 0x02F4},
    {true, 5000, 31, 1, id026, 0x0308},
    {true, 5000, 32, 2, id027, 0x031C},
    {true, 5000, 34, 1, id028, 0x0330},
    {true, 5000, 35, 1, id029, 0x0344},
    {true, 5000, 36, 1, id030, 0x0358},
    {true, 5000, 37, 1, id031, 0x036C},
    {true, 5000, 38, 1, id032, 0x0380},
    {true, 5000, 39, 1, id033, 0x0394},
    {true, 5000, 40, 1, id034, 0x03A8},
    {false, 5000, 41, 2, id035, 0x03BC},
    {false, 5000, 43, 2, id036, 0x03D0},
    {false, 5000, 45, 2, id037, 0x03E4},
    {false, 5000, 47, 2, id038, 0x03F8},
    {false, 5000, 49, 2, id039, 0x040C},
    {false, 5000, 51, 2, id040, 0x0420},
    {false, 5000, 53, 2, id041, 0x0434},
    {false, 5000, 55, 2, id042, 0x0448},
    {false, 5000, 57, 2, id043, 0x045C},
    {false, 5000, 59, 2, id044, 0x0470},
    {false, 5000, 61, 2, id045, 0x0484},
    {false, 5000, 63, 2, id046, 0x0498},
    {false, 5000, 65, 2, id047, 0x04AC},
    {false, 5000, 67, 2, id048, 0x04C0},
    {false, 5000, 69, 2, id049, 0x04D4},
    {true, 5000, 71, 2, id050, 0x04E8},
    {true, 5000, 73, 1, id051, 0x04FC},
    {true, 5000, 74, 1, id052, 0x0510},
    {true, 5000, 75, 1, id053, 0x0524},
    {true, 5000, 76, 2, id054, 0x0538},
    {true, 5000, 78, 2, id055, 0x054C},
    {true, 5000, 80, 2, id056, 0x0560},
    {true, 5000, 82, 1, id057, 0x0574},
    {true, 5000, 83, 1, id058, 0x0588},
    {true, 5000, 84, 2, id059, 0x059C},
    {true, 5000, 86, 2, id060, 0x05B0},
    {true, 5000, 88, 2, id061, 0x05C4},
    {true, 5000, 90, 1, id062, 0x05D8},
    {true, 5000, 91, 1, id063, 0x05EC},
    {true, 5000, 92, 1, id064, 0x0600},
    {true, 5000, 93, 1, id065, 0x0614},
    {true, 5000, 94, 1, id066, 0x0628},
    {true, 5000, 95, 1, id067, 0x063C},
    {true, 5000, 96, 2, id068, 0x0650},
    {true, 5000, 98, 1, id069, 0x0664},
    {true, 5000, 99, 1, id070, 0x0678},
    {true, 5000, 100, 2, id071, 0x068C},
    {true, 5000, 102, 1, id072, 0x06A0},
    {true, 5000, 103, 1, id073, 0x06B4},
    {true, 5000, 104, 1, id074, 0x06C8},
    {true, 5000, 105, 1, id075, 0x06DC},
    {true, 5000, 106, 1, id076, 0x06F0},
    {true, 5000, 107, 1, id077, 0x0704},
    {true, 5000, 108, 1, id078, 0x0718},
    {true, 5000, 109, 1, id079, 0x072C},
    {true, 5000, 110, 1, id080, 0x0740},
    {true, 5000, 111, 1, id081, 0x0754},
    {true, 5000, 112, 1, id082, 0x0768},
    {true, 5000, 113, 1, id083, 0x077C},
    {true, 5000, 114, 1, id084, 0x0790},
    {true, 5000, 115, 1, id085, 0x07A4},
    {true, 5000, 116, 1, id086, 0x07B8},
    {true, 5000, 117, 1, id087, 0x07CC},
    {true, 5000, 118, 1, id088, 0x07E0}
